...
public class userhome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im13=(ImageView) findViewById(R.id.uploads);

        im13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),view_accessories.class));

            }
        });


        im14=(ImageView) findViewById(R.id.notes);

        im14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),view_accessories1.class));
