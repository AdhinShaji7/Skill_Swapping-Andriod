...
public class custom_image3 extends BaseAdapter {
    private Context context;

    String [] date,upload,preq_id;

    public custom_image3(Context con, String[]date, String[]upload)
...
//        this.preq_id=pid;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_image3,null);
