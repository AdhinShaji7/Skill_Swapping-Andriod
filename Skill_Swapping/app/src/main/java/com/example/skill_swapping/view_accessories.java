...
public class view_accessories extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh.getString("ip","");
        String url=sh.getString("url","")+"/user_view_upload";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    upload[i] = u.getString("upload");//dbcolumn name in double quotes
